...
export default function StockTransferManagement() {
  ...
  const stats = [
    { label: 'Total Transfers',  value: 0, subcopy: 'Stock movements',    critical: false },
    { label: 'In Transit',       value: 0, subcopy: 'Currently moving',   critical: false },
    { label: 'Completed',        value: 0, subcopy: 'Delivered',          critical: false },
    { label: 'Total Quantity',   value: 0, subcopy: 'Units transferred',  critical: false },
  ];
      ...
      <div className="space-y-10">
        <section className="hero-gradient glass-panel relative overflow-hidden p-6 md:p-8 text-white">
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-4 text-3xl font-semibold text-white">Stock Transfer Management</h1>
              <p className="mt-2 text-sm text-white/80">
                Manage stock movements between locations. Track transfers in real-time and maintain
        ...
        <section className="glass-panel p-6">
          <div className="text-center py-16">
            <Truck className="mx-auto h-14 w-14 text-white/20" />
            <h3 className="mt-4 text-lg font-semibold text-white">Stock Transfers Coming Soon</h3>
            <p className="mt-2 max-w-md mx-auto text-sm text-white/60">
              Stock transfers between locations will be available in a future update.
              Set up multiple locations from Enterprise settings to enable this feature.
            </p>
          </div>
        </section>
      </div>
